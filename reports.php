				...
				<div class="middle-content">
						<h4 class="title">CLASS ATTENDANCE REGISTER</h4>
                            <div class="alert alert-warning">
                             <i class="fa fa-info"></i>&nbsp;Check the box if the student is present and leave it blank if the studen is absent finally click the student name to see his attendance record for a year
                         </div>
                         <?php 
						$year=date('y');
			            $month=date('m');       
